...
//			"false"),
	...
	PROT_ITEM_USE_MAT(
			...
			"FLINT_AND_STEEL,BUCKET,WATER_BUCKET,LAVA_BUCKET,MINECART,STORAGE_MINECART,INK_SACK,SHEARS,ENDER_PEARL,GLASS_BOTTLE,FIREBALL,ARMOR_STAND,BOAT,NAME_TAG,LEAD",
			"",
	...
	PROT_SWITCH_MAT(
			...
			"DISPENSER,NOTE_BLOCK,CHEST,ENDER_CHEST,FURNACE,BURNING_FURNACE,WOODEN_DOOR,SPRUCE_DOOR,BIRCH_DOOR,JUNGLE_DOOR,ACACIA_DOOR,DARK_OAK_DOOR,LEVER,STONE_PLATE,IRON_DOOR_BLOCK,WOOD_PLATE,STONE_BUTTON,TRAP_DOOR,JUKEBOX,DIODE_BLOCK_OFF,DIODE_BLOCK_ON,FENCE_GATE,SPRUCE_FENCE_GATE,BIRCH_FENCE_GATE,JUNGLE_FENCE_GATE,DARK_OAK_FENCE_GATE,ACACIA_FENCE_GATE,DARK_OAK_GATETRAPPED_CHEST,GOLD_PLATE,IRON_PLATE,REDSTONE_COMPARATOR_OFF,REDSTONE_COMPARATOR_ON,BEACON,HOPPER,DROPPER,MINECART,STORAGE_MINECART,POWERED_MINECART,CARROT_STICK,EXPLOSIVE_MINECART,HOPPER_MINECART,DAYLIGHT_DETECTOR,DAYLIGHT_DETECTOR_INVERTED,TRIPWIRE_HOOK,FLOWER_POT,CAULDRON,BREWING_STAND,ENCHANTING_TABLE",
			"",
